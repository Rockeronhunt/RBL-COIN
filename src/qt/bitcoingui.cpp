...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ROYALBRITISHLEGION address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and royalbritishlegion: URIs)"));
    ...
    aboutAction->setStatusTip(tr("Show information about ROYALBRITISHLEGION Core"));
    ...
    openAction->setStatusTip(tr("Open a royalbritishlegion: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible ROYALBRITISHLEGION command-line options").arg(tr(PACKAGE_NAME)));
...
{
    QString strTitle = tr("ROYALBRITISHLEGION Core"); // default title
    ...
    // Append title to "ROYALBRITISHLEGION Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
