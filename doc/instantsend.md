...
This mechanism has been integrated into Bitcore-Node-ROYALBRITISHLEGION which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/royalbritishlegionpay/insight-api-royalbritishlegion#web-socket-api](https://github.com/royalbritishlegionpay/insight-api-royalbritishlegion#web-socket-api)
* API: [https://github.com/royalbritishlegionpay/insight-api-royalbritishlegion#instantsend-transactions](https://github.com/royalbritishlegionpay/insight-api-royalbritishlegion#instantsend-transactions)
...
By default, the ROYALBRITISHLEGION Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the ROYALBRITISHLEGION Core daemon:
