...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in royalbritishlegion.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("royalbritishlegion.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    ...
    { "royalbritishlegion",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "royalbritishlegion",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "royalbritishlegion",               "gobject",                &gobject,                true,  {} },
    { "royalbritishlegion",               "voteraw",                &voteraw,                true,  {} },
