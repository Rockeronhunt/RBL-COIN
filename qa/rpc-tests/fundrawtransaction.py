...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid royalbritishlegion address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid royalbritishlegion address" in e.error['message'])
