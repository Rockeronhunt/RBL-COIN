...
This document provides guidelines for internationalization of the ROYALBRITISHLEGION Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `royalbritishlegion_en.ts` remains unchanged.
