    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("RBLCOIN-light"), QVariant("light"));
    ui->theme->addItem(QString("RBLCOIN-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("RBLCOIN-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("RBLCOIN-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("RBLCOIN-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("RBLCOIN-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("RBLCOIN-traditional"), QVariant("trad"));
