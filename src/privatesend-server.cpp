...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, const std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all ROYALBRITISHLEGION related functionality
...
/*
    ...
    allow endless transaction that would bloat ROYALBRITISHLEGION and make it unusable. To
...
void ThreadCheckPrivateSendServer(CConnman& connman)
{
    ...
    RenameThread("royalbritishlegion-ps-server");
