...
2. run royalbritishlegiond with -printalert or -sendalert like this:
   /path/to/royalbritishlegiond -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.royalbritishlegion.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/ROYALBRITISHLEGION Core:0.12.0.58/"));
