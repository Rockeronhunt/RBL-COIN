...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print ROYALBRITISHLEGION address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "royalbritishlegion",               "masternode",             &masternode,             true,  {} },
    { "royalbritishlegion",               "masternodelist",         &masternodelist,         true,  {} },
    { "royalbritishlegion",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "royalbritishlegion",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "royalbritishlegion",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "royalbritishlegion",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
