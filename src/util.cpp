...
//ROYALBRITISHLEGION only features
...
const char * const BITCOIN_CONF_FILENAME = "royalbritishlegion.conf";
const char * const BITCOIN_PID_FILENAME = "royalbritishlegiond.pid";
    ...
    if (category != NULL)
    {
        ...
        if (ptrCategory.get() == NULL)
        {
            if (mapMultiArgs.count("-debug")) {
                ...
                // "royalbritishlegion" is a composite category enabling all ROYALBRITISHLEGION-related debug output
                if(ptrCategory->count(std::string("royalbritishlegion"))) {
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/ROYALBRITISHLEGION";
#else
    // Unix
...
void ReadConfigFile(const std::string& confPath)
{
    ...
    if (!streamConfig.good()){
        // Create empty royalbritishlegion.conf if it does not excist
...

    {
        ...
        {
            // Don't overwrite existing settings so command line settings override royalbritishlegion.conf
